<template>
    <div style="background-color: #eae8eb; width: 100%;">
        ...
        <div style="text-align: center;margin-bottom: 30px;">
            <img src="../../assets/logoForCiepTrading.png" style="margin-right: 50px;">
            <input type="text" class="input_sousuo" placeholder="请输入关键字"
                style="border-radius: 18px;height: 42px; width: 528px; border: 2px solid #fd0338;padding-left: 15px; ">
            <button class="button_sousuo">搜索</button>
        </div>
        <div
            style="background-color: #ffffff; width: 1194px; margin: auto; border-radius: 18px; display: flex; flex-wrap: wrap;">
            ...
            <div style="width: 374px; height: 366px; margin-left: auto; border-radius: 12px; margin: 18px 0 0 18px;
                 ">
                <div style="text-align: center;height: 198px;padding-top: 27.5%;">Hi！你好</div><br>

                <div style="text-align: center;">
                    <button class="text_user_caozuo" @click="toUserLogin">登录</button>
                    <button class="text_user_caozuo" style="margin-left: 18px;">注册</button>
                </div><br>
